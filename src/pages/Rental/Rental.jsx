...
const Rental = () => {
  ...
  // 현재 선택 지역구
  const selectedRegionId = parseInt(localStorage.getItem("selectedRegionId"));
  const districtPath = regionIdToDistrict[selectedRegionId] || "jung";
        ...
        {filteredFacilities.length === 0 ? (
          ...
          filteredFacilities.map((facility) => (
            <div
              ...
              onClick={() =>
                navigate(`/${districtPath}/rental/detail/${facility.id}`)
              }
            >
